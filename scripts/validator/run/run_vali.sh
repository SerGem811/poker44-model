...
POKER44_CHUNK_COUNT="${POKER44_CHUNK_COUNT:-120}"
POKER44_REWARD_WINDOW="${POKER44_REWARD_WINDOW:-0}"
...
POKER44_PROVIDER_MIN_EVAL_HANDS="${POKER44_PROVIDER_MIN_EVAL_HANDS:-72}"
POKER44_PROVIDER_MAX_EVAL_HANDS="${POKER44_PROVIDER_MAX_EVAL_HANDS:-160}"
